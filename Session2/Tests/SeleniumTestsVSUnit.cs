...
namespace Tests
{
    ...
    public class SeleniumTestsVSUnit : BaseSeleniumTest
    {
        ...
        string _username = Config.GetGeneralValue("Username");
        string _password = Config.GetGeneralValue("Password");
        /// <summary>
        /// Using config
        /// </summary>
        [TestMethod]
        public void GrabValuesFromConfig()
        {
            ...
            HomePageModel homepage = page.LoginWithValidCredentials(_username, _password);
        ...
        public void UseLogger()
        {
            ...
            page.EnterCredentials(_username, _password);
